...
this.wordle.bundle = function(e) {
    ...
    function setRandomizeLocalStorage(current = null, index = null) {
        ...
        if (!randomize.indices || !randomize.indices.length) {
            randomize.indices = new Array(2315).fill(0,0,2315)
        }

        if (current) randomize.current = current
        if (index) randomize.indices[index] = 1
        
        if (!randomize.current) {
    ...
    function endGameComplete() {
        window.alert('Game Complete!\n\nWow! You finished all of the TileWorldles. Thanks for playing!')
    }
    function randomWord() {
    ...
    function specificWord(index) {
        if (!index) index = eval(solutionLookupFn)(new Date)
    ...
    Sa.innerHTML = '\n  <style>\n  #copyright {text-align: left;}\n.setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n    display: flex;\n    justify-content: space-between;\n    align-items: flex-end;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Hard Mode</div>\n          <div class="description">Any revealed hints must be used in subsequent guesses</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Dark Theme</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Color Blind Mode</div>\n          <div class="description">High contrast colors</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Feedback</div>\n        </div>\n        <div class="control">\n          <a href="https://twitter.com/intent/tweet?screen_name=jasondrewlo" target="blank" title="@jasondrewlo">Twitter</a>\n        </div>\n      </div>\n    </section>\n  </div>\n  <div id="footnote">\n<div id="copyright">Created by <a href="https://twitter.com/intent/tweet?screen_name=powerlanguish" target="blank" title="@powerlanguish">@powerlanguish</a><br>Modified by <a href="https://twitter.com/intent/tweet?screen_name=jasondrewlo" target="blank" title="@jasondrewlo">JSON</a></div>    <div>\n      <div id="puzzle-number"></div>\n      <div id="hash"></div>\n    </div>\n  </div>\n';
    var _a = function(e) {
        r(t, e);
        var a = h(t);
        function t() {
    ...
    var Ta = ['amsterdam','apartment','autopilot','avalanche','backtrack','bam thwok','bear trap','big house','billiards','bisection','blobdance','blobfield','block out','blockpick','blue moon','blue door','blue lock','blue tank','blue wall','bold time','bolkonski','brushfire','buggywall','cccreator','cake walk','campfires','catacombs','ccexplore','centipede','challengo','chchchips','chip suey','chipsters','cineworld','cityblock','clear out','clubhouse','coal mine','communism','confusion','countdown','courtyard','cypher ii','deathtrap','deception','decisions','dodgeball','door ways','dysphoria','eastbound','ectoplasm','eddy limb','elemental','elevators','even step','evil twin','exclusive','excuse me','exit chip','fake exit','fire bugs','fire trap','fire boot','fireflies','flame boy','flame war','flame jet','forsythia','four plex','frostbite','gold rush','green key','half move','hint tile','hook slap','hot block','ice block','jaywalker','joyride i','jumble ii','key color','key mania','key thief','level set','lookalike','madd maze','madness i','main page','malachite','metalhead','microcosm','mike lask','mind game','mind lock','minefield','my friend','nand gate','nightmare','obstacles','optimizer','oracle ii','ouroboros','paramecia','patchwork','patrolled','pentagram','ping pong','pink ball','pink wall','pipe maze','playhouse','potpourri','producing','quickchip','red teeth','red thief','repeaters','replay ii','ruin rush','runaround','same game','sapper do','scoundrel','sdrawkcab','sea queue','shattered','shemozzle','ship ahoy','shrinking','southpole','stopwatch','stratagem','tank help','tank rush','telerooms','teleblast','teleblock','tetragons','thanks to','the marsh','thin wall','thinktank','tileworld','time bomb','time tile','tool shed','triathlon','tripwires','turnstile','two minds','wall slap','waterfall','whirlpool','whos left','wireframe','work fast','yorkhouse']
      , La = ['turnstile','centipede','campfires','half move','main page','key color','shemozzle','the marsh','paramecia','forsythia','two minds','jaywalker','tank rush','cityblock','stratagem','elemental','mind lock','flame boy','sapper do','optimizer','deathtrap','cineworld','time bomb','brushfire','tripwires','dysphoria','exclusive','madd maze','autopilot','dodgeball','level set','thinktank','pink wall','jumble ii','flame war','hint tile','time tile','madness i','fire boot','key mania','blue lock','avalanche','repeaters','cccreator','minefield','telerooms','big house','potpourri','thin wall','courtyard','ping pong','runaround','metalhead','amsterdam','shrinking','same game','ouroboros','fire trap','chipsters','green key','evil twin','oracle ii','bam thwok','buggywall','decisions','replay ii','patchwork','backtrack','elevators','pink ball','red thief','mike lask','patrolled','frostbite','catacombs','shattered','ectoplasm','challengo','blue door','blue wall','blue tank','blue moon','lookalike','work fast','eddy limb','playhouse','producing','ruin rush','stopwatch','coal mine','microcosm','countdown','clear out','chip suey','communism','ship ahoy','key thief','flame jet','deception','malachite','pentagram','teleblock','yorkhouse','blobfield','blockpick','excuse me','ice block','bolkonski','eastbound','billiards','bisection','pipe maze','door ways','four plex','tileworld','confusion','even step','waterfall','whirlpool','scoundrel','quickchip','mind game','my friend','exit chip','fireflies','block out','cypher ii','fake exit','triathlon','fire bugs','red teeth','nightmare','tetragons','gold rush','obstacles','chchchips','wall slap','clubhouse','hook slap','blobdance','thanks to','hot block','bear trap','sdrawkcab','whos left','teleblast','apartment','tank help','tool shed','nand gate','bold time','ccexplore','southpole','cake walk','wireframe','joyride i','sea queue']
      , Ia = "present"
      , Ma = "correct"
      , Oa = "absent";
    var Ra = {
    ...
    var Ha = new Date(2022,1,10,0,0,0,0);
    function Na(e, a) {
        var s = new Date(e)
    ...
    Ka.innerHTML = "\n  <style>\n  .toaster {\n    position: absolute;\n    top: 10%;\n    left: 50%;\n    transform: translate(-50%, 0);\n    pointer-events: none;\n    width: fit-content;\n  }\n  #game-toaster {\n    z-index: ".concat(1e3, ";\n  }\n  #system-toaster {\n    z-index: ").concat(4e3, ';\n  }\n\n  #game {\n    width: 100%;\n    max-width: var(--game-max-width);\n    margin: 0 auto;\n    height: 100%;\n    display: flex;\n    flex-direction: column;\n  }\n  header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    height: var(--header-height);\n    color: var(--color-tone-1);\n    border-bottom: 1px solid var(--color-tone-4);\n  }\n  header .title {\n    font-weight: 700;\n    font-size: 36px;\n    letter-spacing: 0.2rem;\n    text-transform: uppercase;\n    text-align: center;\n    position: absolute;\n    left: 0;\n    right: 0;\n    pointer-events: none;\n  }\n\n  @media (max-width: 360px) {\n    header .title {\n      font-size: 22px;\n      letter-spacing: 0.1rem;\n    }\n  }\n\n  #board-container {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex-grow: 1;\n    overflow: hidden;\n  }\n  #board {\n    display: grid;\n    grid-template-rows: repeat(6, 1fr);\n    grid-gap: 5px;\n    padding:10px;\n    box-sizing: border-box;\n  }\n  button.icon {\n    background: none;\n    border: none;\n    cursor: pointer;\n    padding: 0 4px;\n  }\n\n  #debug-tools {\n    position: absolute;\n    bottom: 0;\n  }\n\n  </style>\n  <game-theme-manager>\n    <div id="game">\n      <header>\n        <div class="menu">\n          <button id="help-button" class="icon" aria-label="help">\n            <game-icon icon="help"></game-icon>\n          </button>\n        <button id="history-button" class="icon" aria-label="history">\n            <game-icon icon="history"></game-icon>\n          </button>\n        </div>\n        <div class="title">\n         TILEWORLDLE\n        </div>\n        <div class="menu">\n          <button id="statistics-button" class="icon" aria-label="statistics">\n            <game-icon icon="statistics"></game-icon>\n          </button>\n          <button id="settings-button" class="icon" aria-label="settings">\n            <game-icon icon="settings"></game-icon>\n          </button>\n        </div>\n      </header>\n        <div style="display: flex;justify-content: space-evenly;align-items: center;padding: 10px 0;"><button id="today" onclick="location.href=`https://github.com/Drewroen/TileWorldle/blob/main/ValidWords.md`">List of Words</button><div id="puzzle-number-title" style="color: var(--color-tone-1);"></div></div>\n     <div id="board-container">\n          <div id="board"></div>\n        </div>\n        <game-keyboard></game-keyboard>\n        <game-modal></game-modal>\n        <game-page></game-page>\n        <div class="toaster" id="game-toaster"></div>\n        <div class="toaster" id="system-toaster"></div>\n    </div>\n  </game-theme-manager>\n  <div id="debug-tools"></div>\n');
    var Qa = document.createElement("template");
    ...
    var Za = "IN_PROGRESS"
      ...
      , ts = function(e) {
        ...
        return o(t, [{
            key: "evaluateRow",
            value: function() {
                if (lengthOfWord === this.tileIndex && !(this.rowIndex >= lengthOfWord + 1)) {
            ...
            key: "addLetter",
            value: function(e) {
                this.gameStatus === Za && (this.canInput && (this.tileIndex >= lengthOfWord || (this.boardState[this.rowIndex] += e,
            ...
            value: function() {
                if (this.gameStatus === Za && this.canInput) {
                    if (lengthOfWord !== this.tileIndex)
            ...
            value: function() {
                var e = this.shadowRoot.querySelector("#board-container")
                  , a = Math.min(Math.floor(e.clientHeight * (lengthOfWord / 6)), lengthOfWord * 70)
                  , s = 6 * Math.floor(a / lengthOfWord);
            ...
            value: function() {
                ...
                this.gameStatus === es && this.rowIndex <= 10 && a.setAttribute("highlight-guess", this.rowIndex),
                a.gameApp = this,
                e.appendChild(a),
                e.setAttribute("open", "")
            }
            ...
            value: function() {
                ...
                for (var a = 0; a < 6; a++) {
                    ...
                    s.setAttribute("length", lengthOfWord),
                ...
                this.shadowRoot.getElementById("history-button").addEventListener("click", (function(a) {
                    var today = new Date
                    var randomize = setRandomizeLocalStorage()
                    var todaysPuzzle = eval(solutionLookupFn)(today)
                    var s = e.$game.querySelector("game-page")
                      , t = document.createTextNode("Past TileWorldles");
                    s.appendChild(t);
                    var o = document.createElement("div");
                    o.setAttribute("id", "history-list")
                    o.setAttribute("page", "")
                    o.setAttribute("slot", "content")
